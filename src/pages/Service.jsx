...
function Service() {
  return (
    <div className="w-full pt-[120px] pb-20 px-4 md:px-10 lg:px-20 overflow-x-hidden" 
         style={{
           background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.95))',
           backgroundSize: 'cover'
         }}>
      <div className="max-w-6xl mx-auto text-white flex flex-col lg:flex-row justify-between items-center gap-12">
        
        {/* Content Section - Somali Translation */}
        <div className="w-full lg:w-[50%] space-y-6 transform -translate-x-10 opacity-0 animate-slide-in-left">
          {/* Heading with Somali translation */}
          <div className="space-y-2">
            <h1 className="text-4xl md:text-5xl font-bold tracking-[0.2em] text-white transform hover:translate-x-4 transition-transform duration-500 ease-out">
              SOO DHAAWO DELIZUS
            </h1>
            <h2 className="text-2xl md:text-3xl italic text-[#da9360] transform hover:translate-x-5 transition-transform duration-500 delay-75 ease-out">
              Fanka Karyadaha
            </h2>
          </div>

          <hr className="border-[#da9360] w-32 my-6 transform origin-left scale-x-0 lg:scale-x-100 hover:scale-x-110 transition-all duration-700 ease-[cubic-bezier(0.68,-0.55,0.27,1.55)]" />
          
          {/* Somali Paragraph */}
          <p className="text-gray-300 leading-relaxed md:leading-loose text-lg transform hover:translate-x-3 transition-all duration-500 ease-out hover:text-white">
            Delizus waxa ku diyaar garoobay macaamiisha cuntooyin tayo sare leh oo lagu sameeyay xirfad iyo dadaal. 
            Kheyraadka dabiiciga ah ee aan isticmaalno waxay hubinayaan in cuntada aad cunto tahay ay tahay mid macaan, 
            caafimaad qaba, oo qurux badan. Ku soo dhawoow aagga ugu wanaagsan ee cuntada ee magaalada.
          </p>
          
          {/* Button with Somali text */}
          <button className="mt-8 bg-transparent border-2 border-[#da9360] text-[#da9360] hover:bg-[#da9360] hover:text-white text-xl font-bold py-2 px-8 rounded-none transform hover:-translate-y-1 transition-all duration-300 ease-out uppercase tracking-widest">
            AKHRISO DHEERIAD
          </button>
        </div>

        {/* Image Section with Darkened Effect */}
        <div className="w-full lg:w-[45%] transform translate-x-10 opacity-0 animate-slide-in-right relative">
          <div className="absolute inset-0 bg-black opacity-40 rounded-lg z-10"></div>
          <img 
            src={chefImage} 
            alt="Karye Delizus" 
            className="w-full h-auto max-h-[600px] object-cover rounded-lg shadow-2xl relative transform hover:-translate-x-3 transition-all duration-500 ease-out hover:shadow-xl"
          />
          <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-black to-transparent z-20 rounded-b-lg"></div>
        </div>
      </div>
