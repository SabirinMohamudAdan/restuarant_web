          ...
          <div className="relative z-10 h-full flex items-center justify-center px-4">
            <div className="text-center w-full max-w-5xl mx-auto">
              ...
              <div className="relative flex items-center justify-between w-full">
                ...
                <div className="h-28 sm:h-36 flex items-center justify-center px-4 mx-4 flex-1">
                  <AnimatePresence mode='wait'>
                    <motion.h1
                      key={currentIndex}
                      initial="hidden"
              ...
              >
                ...
                <motion.button
                  ...
                  whileTap={buttonAnim.tap}
                  className="relative bg-amber-500 text-white px-6 sm:px-8 md:px-10 py-3 sm:py-4 
                   rounded-full overflow-hidden font-medium text-base sm:text-lg md:text-xl"
                >
                  <span className="relative z-10">View Menu</span>
                  <motion.span 
                    className="absolute inset-0 bg-amber-500 rounded-full scale-0 hover:scale-100 origin-center"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {services.map((service, index) => (
                ...
                >
                  <motion.div
                    className="h-[350px] sm:h-[400px] md:h-[450px] border border-[#da9360]/30 rounded-lg
                     bg-black/80 p-4 sm:p-6 overflow-hidden flex flex-col"
                    whileHover={{ 
                      borderColor: "#da9360",
                      boxShadow: "0 10px 25px rgba(218, 147, 96, 0.2)",
